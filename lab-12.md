...
Hypothesis: H0: There is no true difference in the proportion of low
birth weight babies between younger and mature mothers. HA: The
...
The observed difference is 2% in the low weight proportion. However, the
p-value is 0.07, which indicate that the result is not significant. So
this 2% is likely due to chance. Fail to reject the null. There is no
significant difference in the proportion of low birth weight babies in
mature or not mature mom.
...
Based on the sample of mothers in this study, we are 95% confident that
the true difference in the proportion of low birthweight babies between
mature mothers and younger mothers is between 8.4% lower and 3.7% higher
for mature mothers. Since this CI includes 0, it means that there is not
enough evidence to conclude that low birth weight percentage is higher
or lower for mature mothers.
